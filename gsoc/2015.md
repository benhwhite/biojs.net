...
mentors: 
 ...
 - name: Ben White
   ...
   desc: |
       Ben has a Bsc (Hons) in Biological Sciences from the University of East Anglia and two years experience managing high-throughput sequencing and data-analysis projects at The Genome Analysis Centre (TGAC). He is currently studying for a PhD on the visualisation of unreferenced crop genomes at TGAC.
 - name: Bruno Vieira	
